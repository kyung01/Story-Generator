...
public class GrassRenderer : ThingRenderer
{
	public override void Update()
	{
		...
		/*
		if (!g.moduleContainer.Contains(Keyword.FOOD_VEGI))
		{
			this.textMesh.text = "0";
			this.meshRenderer.material.color = new Color(1.0f, 0.0f, 1);
			return;
		}
		this.textMesh.text = ""+(int)g.moduleContainer.Get(Keyword.FOOD_VEGI);
		var grassAmount = g.moduleContainer.Get(Keyword.FOOD_VEGI);

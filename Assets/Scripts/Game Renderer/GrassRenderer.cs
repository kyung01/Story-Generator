...
public class GrassRenderer : ThingRenderer
{
	public override void Update()
	{
		...
		if (!g.container.ContainsKey(Game.Keyword.FOOD_VEGI))
		{
			this.textMesh.text = "0";
			this.meshRenderer.material.color = new Color(1.0f, 0.0f, 1);
			return;
		}
		this.textMesh.text = ""+(int)g.container[Game.Keyword.FOOD_VEGI];
		var grassAmount = g.container[Game.Keyword.FOOD_VEGI];
